...
switch expt
    ...
    case 'TEST'
        ...
        elicitNoise(window, responseHandler, stims.tex, keys, expParams,...
            constants, 0, 1, 0, 'q', noisetex);
        Screen('Close', stims.tex);
        Screen('Close', noisetex);
        
        showPromptAndWaitForResp(window, ['When you think that the two objects are matching, press the ''q'' key\n',...
            'When you think that the two objects are mismatching, press the ''p'' key\n',...
            '\n(The correct answer to this example was ''q'', for matching)'],...
            keys,constants,responseHandler);
        
        showPromptAndWaitForResp(window, 'The first test phase will begin after you press Enter',...
            keys,constants,responseHandler);
