...
instructions = {'The National Institute of Health requests basic demographic information (sex, ethnicity, race, and age) for clinical or behavioral studies, to the extent that this information is provided by research participants.', ...
    '', ...
...
%%% Sex at birth %%%
uicontrol(fig, 'Style', 'text', 'String', '1) Sex at birth:', ...
    'Position', [padding_side height - padding_top - 230, width-padding_side*(1.5), 30], ...
    'HorizontalAlignment','left', 'FontSize', 13);
...
%%% Ethnicity %%%
uicontrol(fig, 'Style', 'text', 'String', '2) Ethnicity:', ...
    'Position', [padding_side height - padding_top - 330, width-padding_side*(1.5), 30], ...
    'HorizontalAlignment','left', 'FontSize', 13);
...
uicontrol(fig, 'Style', 'text', 'String', '3) Race:',...
    'Position', [padding_side height - padding_top - 405, width-padding_side*(1.5), 30], ...
    'HorizontalAlignment','left', 'FontSize', 13);
...
%%% Age %%%
ages = arrayfun(@(x) num2str(x), 18:50,'UniformOutput',false);
uicontrol(fig, 'Style', 'text', 'String', '4) Age:',...
    'Position', [padding_side height - padding_top - 525, width-padding_side*(1.5), 30], ...
    'HorizontalAlignment','left', 'FontSize', 13);
fields.age = uicontrol(fig, 'Style', 'listbox', 'String', [{'Rather not say'},ages], ...
    'Position', [padding_side height - padding_top + 5 - 615, width-padding_side*(1.5), 90]);

% Continue Button
uicontrol(fig, 'Style','pushbutton', 'String', 'Continue', 'Tag', 'RunBtn', 'Callback', 'uiresume(gcbf)', ...
