...
Here is a quick summary of the posterior distribution of the effect of study on RT (using the model where Condition only affected the average RT). This shows the median of the posterior, with error bars extending to from the 2.5 to 97.5 quantiles of the posterior. These distributions being below 0 indicates a significant speed-up.
