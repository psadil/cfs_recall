...
exg_reduced <-  brms::brm(bf(rt_noise | trunc(lb = 0) ~ cue_correct_fct + (1 | subject), sigma ~ cue_correct_fct, beta ~ cue_correct_fct
                             , family = exgaussian() ),
                          prior = c(prior(student_t(3,0,1), class = "b"),
                                    prior(student_t(3,0,1), class = "Intercept"),
                                    prior(gamma(2,1), class = "sd", group = "subject"),
...
exg_muCond <-  brms::brm(bf(rt_noise | trunc(lb = 0) ~ cue_correct_fct*Condition + (1 | subject), sigma ~ cue_correct_fct, beta ~ cue_correct_fct
                             , family = exgaussian() ),
                          prior = c(prior(student_t(3,0,1), class = "b"),
                                    prior(student_t(3,0,1), class = "Intercept"),
                                    prior(gamma(2,1), class = "sd", group = "subject"),
...
exg_betaCond <- brms::brm(bf(rt_noise | trunc(lb = 0) ~ cue_correct_fct*Condition + (1 | subject), sigma ~ cue_correct_fct, beta ~ cue_correct_fct*Condition
                             , family = exgaussian() ),
                          data = exg_brms_d,
                          prior = c(prior(student_t(3,0,1), class = "b"),
                                    prior(student_t(3,0,1), class = "Intercept"),
...
exg_sigmaCond <-  brms::brm(bf(rt_noise | trunc(lb = 0) ~ cue_correct_fct*Condition + (1 | subject), sigma ~ cue_correct_fct*Condition, beta ~ cue_correct_fct
                               , family = exgaussian() ),
                            data = exg_brms_d,
                            prior = c(prior(student_t(3,0,1), class = "b"),
                                      prior(student_t(3,0,1), class = "Intercept"),
...
exg_full <-  brms::brm(bf(rt_noise | trunc(lb = 0) ~ cue_correct_fct*Condition + (1 | subject), sigma ~ cue_correct_fct*Condition, beta ~ cue_correct_fct*Condition
                          , family = exgaussian() ),
                       data = exg_brms_d,
                       prior = c(prior(student_t(3,0,1), class = "b"),
                                 prior(student_t(3,0,1), class = "Intercept"),
